...
После этого откройте `dist/index.html`. Вид по умолчанию: **Авто** — на узких экранах (до 740px) карточки, на широких — таблица. Переключение **Авто / Карточки / Таблица** — в меню настроек (иконка шестерёнки в правом верхнем угу), настройка сохраняется в `localStorage`.
